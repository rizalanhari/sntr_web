                        ...
                        <form method="post" action="{{ route('admin.store.tambah.pondok') }}">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namapondok" name="namapondok"
                                        placeholder="Masukkan Nama Pondok">

                                    <div class="form-group">
                                        <label for="Alamat">Alamat</label>
                                        <input type="text" class="form-control" id="alamatpondok" name="alamatpondok"
                                            placeholder="Masukkan Alamat Pondok">

                                        <div class="form-group">
                                            <label for="No Telfon">No Telfon</label>
                                            <input type="text" class="form-control" id="notelfon" name="notelfon"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="webpondok" name="webpondok"
                                                        placeholder="Masukkan Alamat Web Pondok">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="gambarpondok">Choose
                                                                file</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 text-center">
                                                        ...
                                                        <button type="button" class=" btn btn-info btn-md"
                                                            data-toggle="modal" data-target="#myModal">Open Map
                                                            Location</button>
